...
/**
 * The Class DatastageParameterSet.
 */
public class DatastageParameterSet extends DatastageAbstractNode {
  ...
  /**
   * Instantiates a new datastage parameter set.
   */
  public DatastageParameterSet() {
