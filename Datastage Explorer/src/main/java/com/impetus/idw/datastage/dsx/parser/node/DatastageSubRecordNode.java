...
/**
 * The Class DatastageSubRecordNode.
 */
public class DatastageSubRecordNode extends DatastageAbstractNode {
  ...
  /**
   * Instantiates a new datastage sub record node.
   */
  public DatastageSubRecordNode() {
