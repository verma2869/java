...
/**
 * The Class DatastageTableDefNode.
 */
public class DatastageTableDefNode extends DatastageAbstractNode {
  ...
  /**
   * Instantiates a new datastage table def node.
   */
  public DatastageTableDefNode() {
