...
/**
 * The Class DatastageHeaderNode.
 */
public class DatastageHeaderNode extends DatastageAbstractNode {
  ...
  /**
   * Instantiates a new datastage header node.
   */
  public DatastageHeaderNode() {
