...
/**
 * The Class DatastageBPSourceNode.
 */
public class DatastageBPSourceNode extends DatastageAbstractNode {
  ...
  /**
   * Instantiates a new datastage BP source node.
   */
  public DatastageBPSourceNode() {
