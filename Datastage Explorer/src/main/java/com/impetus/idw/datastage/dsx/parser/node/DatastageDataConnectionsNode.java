...
/**
 * The Class DatastageDataConnectionsNode.
 */
public class DatastageDataConnectionsNode extends DatastageAbstractNode {
  ...
  /**
   * Instantiates a new datastage data connections node.
   */
  public DatastageDataConnectionsNode() {
